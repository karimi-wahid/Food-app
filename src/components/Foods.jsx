        ...
        <div className='flex flex-col lg:flex-row justify-between'>
            ...
            <div>
                ...
                <div className='flex justify-between max-w-[390px] w-full'>
                    <button onClick={() => priceFilter('$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>10$</button>
                    <button onClick={() => priceFilter('$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>20$</button>
                    <button onClick={() => priceFilter('$$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>30$</button>
                    <button onClick={() => priceFilter('$$$$')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>40$</button>
                </div>
            </div>
        </div>
